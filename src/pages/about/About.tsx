  ...
  return (
    <div className="ui-lib-d365-app">
      ...
      <header className="ui-lib-d365-header">
        <div className="ui-lib-d365-header__logo">
          <img 
            src="/WebResources/err403_/logo.svg" 
            alt="err403 Logo" 
            className="ui-lib-d365-header__logo-icon"
            style={{ width: '32px', height: '32px', marginRight: '8px' }}
          />
          <span>err403 UI Library</span>
          {PACKAGE_VERSION && <span className="ui-lib-d365-version">v{PACKAGE_VERSION}</span>}
        </div>
      ...
      {/* Tabs */}
      <div className="ui-lib-d365-tabs">
        {tabs.map(tab => (
          <button
            key={tab.id}
            className={`ui-lib-d365-tab ${activeTab === tab.id ? 'ui-lib-d365-tab--active' : ''}`}
            onClick={() => setActiveTab(tab.id)}
          >
            <span className="ui-lib-d365-tab__icon">{tab.icon}</span>
            <span className="ui-lib-d365-tab__label">{tab.label}</span>
          </button>
        ))}
      </div>
      ...
      <main className="ui-lib-d365-main">
        <div className="ui-lib-d365-tab-content">
      ...
      <footer className="ui-lib-d365-footer">
        ...
        <div className="ui-lib-d365-footer__links">
